                        ...
                        child: IconButton(
                            ...
                            onPressed: () {
                              _dataController2.setMinAge(
                                  _dataController.ageControl.value.start);
            ...
            if (snapshot.hasData) {
                ...
                if (cntrCode.contains(element.data()['countryCode'])) {
                  ...
                  users.add(
                    Marker(
                      ...
                      infoWindow:
                      InfoWindow(title: '${element.data()['name']}'),
                      position: LatLng(element.data()['geoLoc'].latitude,
                          element.data()['geoLoc'].longitude),
                      icon: BitmapDescriptor.fromBytes(markerIcon),
                      onTap: () {
                        Get.to(
                            ProfileCommon(
                              fromMapGetBack: true,
                              reciverName: element.data()['name'],
                            ),
              ...
              return GoogleMap(
                ...
                initialCameraPosition: CameraPosition(
                    target: _dataController.myLocation ??
                        myLoc ??
                        startLocationError,
                    zoom: 12),
